...
* [USD Cookbook](https://github.com/ColinKennedy/USD-Cookbook) ⭐ 692 | 🐛 3 | 🌐 Mathematica | 📅 2024-08-17 Colin Kennedy's USD code and asset samples
...
* [Gaffer](https://github.com/GafferHQ/gaffer) ⭐ 1,098 | 🐛 373 | 🌐 Python | 📅 2026-09-26 USD is available for SceneReader node and SceneWriter node from v0.42.0.0
* [Maya](https://github.com/Autodesk/maya-usd) ⭐ 907 | 🐛 341 | 🌐 Wolfram Language | 📅 2026-09-25 Autodesk Maya plugin
* [Unity USD SDK](https://github.com/Unity-Technologies/usd-unity-sdk) ⭐ 525 | 🐛 48 | 🌐 C# | 📅 2024-11-25 Full C# bindings to the USD SDK
...
* [3ds Max](https://github.com/Autodesk/3dsmax-usd) ⭐ 95 | 🐛 15 | 🌐 C++ | 📅 2026-08-31 Autodesk 3ds Max plugin
...
* [AMD ProRender](https://github.com/GPUOpen-LibrariesAndSDKs/RadeonProRenderUSD) ⭐ 243 | 🐛 44 | 🌐 C++ | 📅 2025-08-05 AMD ProRender raytracing Hydra delegate
...
* [Official USD repo](https://github.com/PixarAnimationStudios/USD) ⭐ 7,506 | 🐛 1,003 | 🌐 C++ | 📅 2026-09-26 The repo includes a robust build script that pulls canonical dependency sources, and can build for all supported platforms.
