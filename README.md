...
* [Gaffer](https://github.com/GafferHQ/gaffer) ⭐ 1,084 | 🐛 368 | 🌐 Python | 📅 2026-08-13 USD is available for SceneReader node and SceneWriter node from v0.42.0.0
* [Maya](https://github.com/Autodesk/maya-usd) ⭐ 898 | 🐛 327 | 🌐 Wolfram Language | 📅 2026-08-12 Autodesk Maya plugin
* [Unity USD SDK](https://github.com/Unity-Technologies/usd-unity-sdk) ⭐ 524 | 🐛 49 | 🌐 C# | 📅 2024-11-25 Full C# bindings to the USD SDK
...
* [USD Qt](https://github.com/LumaPictures/usd-qt) ⭐ 170 | 🐛 5 | 🌐 Python | 📅 2023-10-10 Luma Pictures has created some reusable Qt widgets to work with USD
...
* [Official USD repo](https://github.com/PixarAnimationStudios/USD) ⭐ 7,440 | 🐛 1,007 | 🌐 C++ | 📅 2026-08-06 The repo includes a robust build script that pulls canonical dependency sources, and can build for all supported platforms.
